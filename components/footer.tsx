      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
          ...
          <div>
            ...
            <div className="space-y-2 md:space-y-3">
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <span className="text-gray-300 text-xs md:text-sm">{footerData?.contactAddress || "Addis Ababa, Ethiopia"}</span>
              </div>
              <div className="flex items-center gap-2 md:gap-3">
        ...
        <div className="border-t border-gray-800 mt-6 md:mt-8 pt-6 md:pt-8 text-center">
          <p className="text-gray-400 text-xs md:text-sm">
            {footerData?.copyrightText || `\u00a9 2025 Meed International School. ${t("All rights reserved.")}`}
          </p>
        </div>
      </div>
    </footer>
