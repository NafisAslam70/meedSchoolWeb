      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
          ...
          <div>
            ...
            <div className="space-y-1.5 md:space-y-2">
              {[
                ...
                "MSP & MHCP Programs",
                "Baseline & Banding (T1-T4)",
              ].map((p, i) => (
                <Link key={i} href="/programs" className="block text-gray-300 hover:text-emerald-400 transition-colors text-xs md:text-sm">
                  {t(p)}
                </Link>
              ))}
            </div>
          ...
          <div>
            ...
            <div className="space-y-2 md:space-y-3">
              ...
              <div className="flex items-center gap-2 md:gap-3">
                ...
                <span className="text-gray-300 text-xs md:text-sm">+251 123 456 78</span>
              </div>
              <div className="flex items-center gap-2 md:gap-3">
                <Mail className="h-4 w-4 text-emerald-400 flex-shrink-0" />
                <span className="text-gray-300 text-xs md:text-sm break-all">info@meedinternational.edu</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-6 md:mt-8 pt-6 md:pt-8 text-center">
          <p className="text-gray-400 text-xs md:text-sm">
            &copy; 2025 Meed International School. {t("All rights reserved.")}
          </p>
        </div>
      </div>
    </footer>
